    ...
    <>
        ...
        <div className="grid grid-cols-6 gap-3">
          <div className="col-span-6 md:col-span-4 lg:col-span-2">
            <div className="big product-img w-full">
              <img className="" src="shirt2.png" alt="" />
            </div>
          </div>
          <div className="col-span-6 md:col-span-2 lg:col-span-1 md:order-first lg:order-first">
            <div className="flex md:flex-col lg:flex-col justify-between">
              <div className="small product-img flex justify-center">
                {" "}
                <img style={{height: '100%'}} className="h-full" src="shirt.png" alt="" />
              </div>

              <div className="small product-img flex justify-center">
                {" "}
                <img className="h-full" src="shirt.png" alt="" />
              </div>
          ...
          <div className="col-span-6 lg:col-span-3">
            <h1 className="product-hero-text">One Life Graphic Tshirt</h1>
            <div className="flex mt-2 mb-2">
              {[1, 2, 3, 4].map((e) => (
                <Star />
              ))}

              <span className="product-rate-numerator">4/</span>
              <span className="product-rate-denom">5</span>
            </div>

            <div className="flex items-center">
              <p className="product-page-price mr-3">$260</p>
              <p className="product-strike-price mr-3">$300</p>
              <p className="product-discount-percent">-20%</p>
            </div>
            ...
            <div className="product-section">
              ...
              <div className="flex flex-wrap">
                {sizes.map((e) => (
                  <button className="size-button mr-2">{e}</button>
                ))}
              </div>
            </div>
            ...
            <div className="flex items-center">
              <div className="size-button flex justify-between w-1/3 mr-2">
                ...
                <button style={{ background: "transparent", fontSize: "1rem" }}>
                  1
                </button>
                <button style={{ background: "transparent" }}>
                  <svg
      ...
      <div className="container mx-auto px-4 lg:px-20">
        ...
        <div className="content">
          ...
          <h1 className="header-text my-8 text-center">You might also like</h1>

          <div className="grid grid-cols-4 gap-3 mb-10">
            {[1, 2, 3, 4].map((e) => (
              <div className="col-span-4 md:col-span-2 lg:col-span-1">
                <img className="product-img" src={`shirt${e}.png`} alt="" />
                <p className="product-label">Gradient Graphic T-shirt</p>
                <div className="flex mt-2 mb-2">
                  {[1, 2, 3, 4].map((e) => (
                    <Star />
                  ))}
